...
Hardware,Test Touch Screen,*#*#2664#*#*,Verifica la precisione e i punti morti del pannello.
Hardware,Sensore Prossimità,*#*#0588#*#*,Test del sensore che spegne lo schermo in chiamata.
Hardware,Vibrazione/Backlight,*#*#0842#*#*,Test del motorino vibrante e della retroilluminazione.
Hardware,Test Audio,*#*#0673#*#*,Test degli altoparlanti e delle frequenze audio.
Hardware,Info Fotocamera,*#*#34971539#*#*,"Dettagli firmware fotocamera (ATTENZIONE: Non aggiornare)."
Connettività,MAC Wi-Fi,*#*#232338#*#*,Visualizza l'indirizzo fisico della scheda Wi-Fi.
Connettività,Test Bluetooth,*#*#232331#*#*,Esegue un test di connessione del chip Bluetooth.
Connettività,Test GPS,*#*#1472365#*#*,Esegue un test rapido del ricevitore GPS integrato.
...
Utility,Backup Media,*#*#273282*255*663282*#*#*,Schermata per il backup rapido di immagini e video.
Utility,Service Mode,*#*#197328640#*#*,Menu di servizio per test ingegneristici avanzati.
Reset,Factory Reset,*#*#7780#*#*,Ripristino dati di fabbrica (mantiene il firmware attuale).
Reset,Factory Format,*2767*3855#,Formattazione totale e reinstallazione del firmware.
